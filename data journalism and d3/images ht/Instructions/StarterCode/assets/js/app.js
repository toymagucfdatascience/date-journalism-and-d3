...
============================================
// Before coding we need to set up and  define the attributes ,width,height and margins of the graph.
/// Note: I also added room for label text as well as text padding,
// though not all graphs will need all these specifications.
...
// Note: Making this  function allows us to easily call
// it  is in the mobility section of our code.
var circRadius;
function crGet() {
  if (width <= 530) {
    circRadius = 5;
...
function visualize(theData) {
  ...
  // a. find the data min & max for scaling x
  function xMinMax() {
  ...
  // c. update the classes (and appearance) of label text when clicked.
  ...
  // Find the data min and max values for scaliny x and y.
  xMinMax();
  yMinMax();
  ...
  // append the axis to the  svg as group elements. By calling them, we include
  ...
  // Part 4: Make the Graph Dynamic on click
  // ==========================
  // This  part will allow the user to click on any label
  ...
  d3.selectAll(".aText").on("click", function() {
    ...
    if (self.classed("inactive")) {
      // obtain the name and axis saved in label.
      ...
      if (axis === "x") {
        ...
        // update  the min and max of the x-axis
        xMinMax();
        ...
        // We need to update the location of the state texts, too.
        ...
        // Finally, update the classes of the last active label and the clicked label.
